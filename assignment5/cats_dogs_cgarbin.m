%% CAP 4401 - Digital Image Processing - FAU - Dr. Marques - Spring 2021 

%% Starter code (2-class classifier: cats vs. dogs)

% Inspired by (and based on) "Deep Learning for Pet Classification" example (MathWorks)  
...
%% 1.3: Inspect the network weights for the second convolutional layer
...
% TODO Test it on additional images, e.g., the iconic "Doge"
% ENTER CODE HERE
% ..
% ..
% ..
...
% TODO: In this part, use the Kaggle dataset and basically repeat the
